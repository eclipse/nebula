...
import org.eclipse.nebula.jface.gridviewer.GridViewer;
...
public class GridViewerSnippet1 {
	...
	public GridViewerSnippet1(Shell shell) {
		...
		GridViewerEditor gridViewerEditor = new GridViewerEditor(v, actSupport, ColumnViewerEditor.TABBING_HORIZONTAL
				| ColumnViewerEditor.TABBING_MOVE_TO_ROW_NEIGHBOR
				| ColumnViewerEditor.TABBING_VERTICAL | ColumnViewerEditor.KEYBOARD_ACTIVATION);
		
		v.setColumnViewerEditor(gridViewerEditor);
