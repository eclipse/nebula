...
//		GanttGroup gg = new GanttGroup(ganttChart);
		...
		gg.addEvent(ge);
		gg.setFixedRowHeight(100);
		gg.setVerticalEventAlignment(SWT.BOTTOM);
		gg.addEvent(ge2);
		
		Calendar start3 = Calendar.getInstance();
		Calendar end3 = Calendar.getInstance();
		start3.add(Calendar.DATE, 1);
		end3.add(Calendar.DATE, 5);
		GanttEvent ge3 = new GanttEvent(ganttChart, "C", start3, end3, 10);
		ge3.setStatusColor(ColorCache.getColor(81, 104, 145));
		ge3.setGradientStatusColor(ColorCache.getColor(168, 185, 216));
		
		Calendar start4 = Calendar.getInstance();
		Calendar end4 = Calendar.getInstance();
		start4.add(Calendar.DATE, 1);
		end4.add(Calendar.DATE, 5);
		GanttEvent ge4 = new GanttEvent(ganttChart, "D", start4, end4, 10);
		ge4.setStatusColor(ColorCache.getColor(81, 104, 145));
		ge4.setGradientStatusColor(ColorCache.getColor(168, 185, 216));
		*/
