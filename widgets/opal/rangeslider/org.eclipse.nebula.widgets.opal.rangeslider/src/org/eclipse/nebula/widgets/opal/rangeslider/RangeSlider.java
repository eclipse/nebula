...
public class RangeSlider extends Canvas {
	 ...
	 * size. if the current size is less than 40, no tick marks are produced.
	 */
	 ...
	 * breadth. we generate at least ten divisions, but fewer if the ticks are too
	 * compact. some factor of pageIncrement is the preferred tick division. if too
	 * few ticks are generated from pageIncrement then increment is used. if too few
	 * ticks are generated from increment some smaller value is used if style is
	 * SMOOTH.
	 */
