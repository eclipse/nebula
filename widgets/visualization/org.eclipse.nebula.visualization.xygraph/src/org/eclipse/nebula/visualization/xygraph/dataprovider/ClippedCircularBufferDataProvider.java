...
/**
 * {@link CircularBufferDataProvider} with a limited window on the trace data for computing data ranges. 
 */
public class ClippedCircularBufferDataProvider extends CircularBufferDataProvider {
	...
	/**
	 * Ranges are computed from local min/max values from within the given window.
	 */
	@Override
