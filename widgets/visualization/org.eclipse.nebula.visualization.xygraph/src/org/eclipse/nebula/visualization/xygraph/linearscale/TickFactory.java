...
public class TickFactory {
	...
	public static ITicksProvider createLinearScaleTicksProvider(IScaleProvider scale) {
		return new LinearScaleTicks(scale);
	}

	public static ITicksProvider createLinearScaleTicks2Provider(IScaleProvider scale) {
		return new LinearScaleTicks2(scale);
	}
