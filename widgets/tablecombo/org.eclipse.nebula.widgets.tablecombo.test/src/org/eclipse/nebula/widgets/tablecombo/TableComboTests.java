...
public class TableComboTests {
  ...
  public void testDisplayOfItems() {
     ...
     * must match the number of TableItems.
     */
    ...
    assertEquals("Expected the number of items in the table widget of the TableCombo to be the same as the number of TableItems added to the TableCombo", 5, tableBot
        .rowCount());
  ...
  public void testDisplayOfColumns() {
     ...
     * TableCombo must match the configured number
     */
    final SWTBot shellBot = new SWTBot(shell);
    final TableCombo tableComboWidget = shellBot
        .widget(WidgetMatcherFactory.widgetOfType(TableCombo.class));
    ...
    assertEquals("Expected the number of columns in the table widget of the TableCombo to be the same as the number of columns configured in the TableCombo", 3, tableBot
        .columnCount());

  }

  /**
   * Ensures that the text displayed in tableCombo text widget corresponds to
   * the item selected in the tableCombo.
   */
  @Test
  public void testSelectionOfSingleItem() {
    ...
    /*
     * WHEN the TableCombo gets displayed and a single item is selected in the
     * table combo
     */
    shell.open();
    ...
    /*
     * THEN the text displayed in tableCombo text widget must correspond to the
     * item selected in the tableCombo.
     */
    assertEquals("Expected the text displayed in the tableCombo text widget to correspond to the item selected in the tableCombo", "Item 0", tableComboWidget
        .getText());
