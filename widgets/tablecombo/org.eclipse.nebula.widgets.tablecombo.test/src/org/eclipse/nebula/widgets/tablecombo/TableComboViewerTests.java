...
public class TableComboViewerTests {
  ...
  public void testDisplayOfItems() {
    ...
    /*
     * GIVEN a TableComboViewer with two columns and a number of items set as
     * input of the TableComboViewer.
     */
    ...
    /*
     * THEN the number of rows displayed in the table widget of the
     * TableComboViewer must match the number of items.
     */
    ...
    assertEquals("Expected the number of items in the table widget of the TableCombo to be the same as the number of items added to the TableComboViewer", 5, tableBot
        .rowCount());

  }

  /**
   * Ensures that the properties of the items for the {@link TableComboViewer}
   * are correctly displayed in the cells of the table widget.
   */
  @Test
  public void testDisplayOfCellValues() {
    ...
    assertEquals("Expected the number of columns in the table widget of the TableComboViewer to be the one as defined for the TableComboViewer", 2, tableBot
        .columnCount());
    assertEquals("Expected the value in the cell [0,1] in the table widget of the TableComboViewer to correspond to the description of first item set as input for the TableComboViewer", "Description 0", tableBot
        .cell(0, 1));
    assertEquals("Expected the value in the cell [1,0] in the table widget of the TableComboViewer to correspond to the name of second item set as input for the TableComboViewer", "Item 1", tableBot
        .cell(1, 0));
  ...
  private class TestLabelProvider extends LabelProvider
