...
public class TableComboSnippet {
	...
	public static void main(String[] args) {
		...
		// create images
		testImage = ImageDescriptor.createFromFile(TableComboSnippet.class, 
			"in_ec_ov_success_16x16.gif").createImage();
		test2Image = ImageDescriptor.createFromFile(TableComboSnippet.class, 
			"in_ec_ov_warning_16x16.gif").createImage();
		test3Image = ImageDescriptor.createFromFile(TableComboSnippet.class, 
