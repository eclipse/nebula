 ...
 * {@link ITreeContentProvider} that places the nested contents inside 
 * a single root node.
 * 
...
public class FlatTreeContentProvider implements ITreeContentProvider {
	...
	/**
	 * Adapts an {@link IStructuredContentProvider} into an {@link ITreeContentProvider}
	 * that places the nested contents inside a single root node.
	 * 
	 * @param provider the {@link IStructuredContentProvider} to adapt
	 */
	...
	/**
	 * Adapts an {@link IStructuredContentProvider} into an {@link ITreeContentProvider}
	 * that places the nested contents inside the given root node.
	 * 
	 * @param provider the {@link IStructuredContentProvider} to adapt
	 * @param the single root node for the tree
	 */
